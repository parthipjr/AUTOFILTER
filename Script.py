class script(object):
    START_TXT = """ <b>🖤✨ Hᴇʏ {}, Wᴇʟᴄᴏᴍᴇ ᴛᴏ  Cɪɴᴇꜰʟɪx Cᴏᴍᴍᴜɴɪᴛʏ 🎬</b>

<b>I am Cɪɴᴇꜰʟɪx Aᴜᴛᴏꜰɪʟᴛᴇʀ Bᴏᴛ 🤖</b>
✨➠ Just type the title & I’ll fetch it instantly.
⚡➠ Give me Admin Power in your group to unlock full access."""
    HELP_TXT = """
     Hey  {} 
